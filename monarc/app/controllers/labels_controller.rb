class LabelsController < ApplicationController
  ...
  def index
    ...
    # format.html
    # format.json do
    #   render json: LabelsDatatable.new(view_context)
    # end
    #end
  end
  ...
  def destroy
    @label.destroy
    respond_to do |format|
      format.html { redirect_to session.delete(:return_to), notice: 'Label was successfully destroyed.' }
  ...
  private
    ...
    def label_params
      params.require(:label).permit(:name, :description, :parent_id, :parent)
    end
end
