...
RSpec.describe ProvidersController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Provider" do
        expect {post :create, params: {provider: valid_attributes}, session: valid_session}.to change(Provider, :count).by(1)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested provider" do
      provider = Provider.create! valid_attributes
      expect {delete :destroy, params: {id: provider.to_param}, session: valid_session}.to change(Provider, :count).by(-1)
    end
